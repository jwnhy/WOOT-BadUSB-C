...
The security of \ac{USB} protocol has been paid extensive attention to because of its
    ...
    disguising normal \ac{USB} devices as human interface devices like keyboards and
    ...
    extended BadUSB to support the new features of \ac{USB} Type-C and proposed a
