...
The security of USB protocol has been paid extensive attention to because of its
    ...
    obtain the status of user interface to conduct precise attacks as well as get the visual feedback of their attacks.  In this work, we
