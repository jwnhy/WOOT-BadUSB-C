...
\DIFdelbegin %DIFDELCMD < \bibliography{BadUSBC}
%DIFDELCMD < %%%
...
\DIFadd{J.~D. Tian, N.~Scaife, D.~Kumar, M.~Bailey, A.~Bates, and K.~R.~B. Butler,
  ``Sok: "plug }{\DIFadd{\&}} \DIFadd{pray" today - understanding }{\DIFadd{USB}} \DIFadd{insecurity in versions 1
  through }{\DIFadd{C}}\DIFadd{,'' in }\emph{\DIFadd{2018 }{\DIFadd{IEEE}} \DIFadd{Symposium on Security and Privacy, }{\DIFadd{SP}}
  \DIFadd{2018, Proceedings, 21-23 May 2018, San Francisco, California, }{\DIFadd{USA}}}\DIFadd{.}\hskip
  \DIFadd{1em plus 0.5em minus 0.4em}\relax {\DIFadd{IEEE}} \DIFadd{Computer Society, 2018, pp.
  1032--1047. }[\DIFadd{Online}]\DIFadd{. Available: }\url{https://doi.org/10.1109/SP.2018.00037}
\BIBentrySTDinterwordspacing

\bibitem{website:CVE-list}
\BIBentryALTinterwordspacing
\DIFadd{``Common vulnerabilities and exposures,'' 2020. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://cve.mitre.org/}
\BIBentrySTDinterwordspacing

\bibitem{badusb}
\DIFadd{K.~Nohl and J.~Lell, ``Badusb-on accessories that turn evil,'' }\emph{\DIFadd{Black Hat
  USA}}\DIFadd{, vol.~1, no.~9, pp. 1--22, 2014.
}

\bibitem{hid}
\DIFadd{USB-IF, ``Device class definition for human interface devices (}{\DIFadd{HID}}\DIFadd{),'' 2001.
}

\bibitem{tian2015defending}
\BIBentryALTinterwordspacing
\DIFadd{J.~D. Tian, A.~Bates, and K.~R.~B. Butler, ``Defending against malicious }{\DIFadd{USB}}
  \DIFadd{firmware with goodusb,'' in }\emph{\DIFadd{Proceedings of the 31st Annual Computer
  Security Applications Conference, Los Angeles, CA, USA, December 7-11,
  2015}}\DIFadd{.}\hskip \DIFadd{1em plus 0.5em minus 0.4em}\relax {\DIFadd{ACM}}\DIFadd{, 2015, pp. 261--270.
  }[\DIFadd{Online}]\DIFadd{. Available: }\url{https://doi.org/10.1145/2818000.2818040}
\BIBentrySTDinterwordspacing

\bibitem{usbclist}
\BIBentryALTinterwordspacing
\DIFadd{EverybodyWiki, ``List of devices with video output over usb-c,'' 2021.
  }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://en.everybodywiki.com/List_of_devices_with_video_output_over_USB-C#Devices_with_DisplayPort_Alternate_Mode_over_USB-C}
\BIBentrySTDinterwordspacing

\bibitem{usb10}
\DIFadd{Compaq, D.~E. Corporation, I.~P. Company, Intel, Microsoft, NEC, and
  N.~Telecom., }\emph{\DIFadd{Universal Serial Bus Specification, Revision 1.0}}\DIFadd{, January
  1996.
}

\bibitem{usb11}
\DIFadd{------, }\emph{\DIFadd{Universal Serial Bus Specification, Revision 1.1}}\DIFadd{, September
  1998.
}

\bibitem{usb20}
\DIFadd{------, }\emph{\DIFadd{Universal Serial Bus Specification, Revision 2.0}}\DIFadd{, April 2000.
}

\bibitem{rubber}
\BIBentryALTinterwordspacing
\DIFadd{Hak5, ``Episode 709: Usb rubber ducky part 1,'' 2013. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{http://hak5.org/episodes/episode-709}
\BIBentrySTDinterwordspacing

\bibitem{usb30}
\DIFadd{I.~HP }\emph{\DIFadd{et~al.}}\DIFadd{, ``Universal serial bus 3.0 specification,'' 2008.
}

\bibitem{usb31}
\DIFadd{------, ``Universal serial bus 3.1 specification,'' 2013.
}

\bibitem{usb32}
\DIFadd{I.~M. R.~S. Apple, Hewlett-Packard and T.~Instruments., ``Universal serial bus
  3.2 specification,'' 2017.
}

\bibitem{typec}
\DIFadd{G.~Chandler }\emph{\DIFadd{et~al.}}\DIFadd{, }\emph{\DIFadd{Universal Serial Bus Type-C Cable and
  Connector Specification}}\DIFadd{.
}

\bibitem{usbif}
\BIBentryALTinterwordspacing
\DIFadd{``}{\DIFadd{USB}} \DIFadd{implementers forum,'' 1995. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://www.usb.org/about/}
\BIBentrySTDinterwordspacing

\bibitem{usbsec}
\DIFadd{USB-IF, ``}{\DIFadd{USB-IF}} \DIFadd{statement regarding }{\DIFadd{USB}} \DIFadd{security,'' 2014.
}

\bibitem{duqu}
\DIFadd{P.~Szor, ``Duqu--threat research and analysis,'' }\emph{\DIFadd{McAfee Labs}}\DIFadd{, 2011.
}

\bibitem{JFC}
\BIBentryALTinterwordspacing
\DIFadd{W.~Meng, L.~W. Hao, M.~S. Ramanujam, and S.~P.~T. Krishnan, ``Charging me and
  }{\DIFadd{I}} \DIFadd{know your secrets!: Towards juice filming attacks on smartphones,'' in
  }\emph{\DIFadd{Proceedings of the 1st }{\DIFadd{ACM}} \DIFadd{Workshop on Cyber-Physical System
  Security, }{\DIFadd{CPSS}} \DIFadd{2015, Singapore, Republic of Singapore, April 14 - March 14,
  2015}}\DIFadd{, J.~Zhou and D.~Jones, Eds.}\hskip \DIFadd{1em plus 0.5em minus 0.4em}\relax
  {\DIFadd{ACM}}\DIFadd{, 2015, pp. 89--98. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://doi.org/10.1145/2732198.2732205}
\BIBentrySTDinterwordspacing

\bibitem{JFCImpact}
\BIBentryALTinterwordspacing
\DIFadd{W.~Meng, L.~W. Hao, Z.~Liu, C.~Su, and Y.~Li, ``Evaluating the impact of juice
  filming charging attack in practical environments,'' in }\emph{\DIFadd{Information
  Security and Cryptology - }{\DIFadd{ICISC}} \DIFadd{2017 - 20th International Conference,
  Seoul, South Korea, November 29 - December 1, 2017, Revised Selected Papers}}\DIFadd{,
  ser. Lecture Notes in Computer Science, H.~Kim and D.~Kim, Eds., vol.
  10779.}\hskip \DIFadd{1em plus 0.5em minus 0.4em}\relax \DIFadd{Springer, 2017, pp. 327--338.
  }[\DIFadd{Online}]\DIFadd{. Available: }\url{https://doi.org/10.1007/978-3-319-78556-1\_18}
\BIBentrySTDinterwordspacing

\bibitem{facedancer}
\BIBentryALTinterwordspacing
\DIFadd{GoodFET, ``Facedancer21,'' 2016. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{http://goodfet.sourceforge.net/hardware/facedancer21}
\BIBentrySTDinterwordspacing

\bibitem{syzkaller}
\BIBentryALTinterwordspacing
\DIFadd{Google, ``Found linux kernel usb bugs,'' 2017. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://github.com/google/syzkaller/blob/master/docs/linux/found\_bugs\_usb.md}
\BIBentrySTDinterwordspacing

\bibitem{rubberducky2020}
\DIFadd{A.~D. }{\DIFadd{Ramadhanty}}\DIFadd{, A.~}{\DIFadd{Budiono}}\DIFadd{, and A.~}{\DIFadd{Almaarif}}\DIFadd{, ``Implementation and
  analysis of keyboard injection attack using usb devices in windows operating
  system,'' in }\emph{\DIFadd{2020 3rd International Conference on Computer and
  Informatics Engineering (IC2IE)}}\DIFadd{, 2020, pp. 449--454.
}

\bibitem{usbbypassing}
\DIFadd{J.~Bang, B.~Yoo, and S.~Lee, ``Secure usb bypassing tool,'' }\emph{\DIFadd{digital
  investigation}}\DIFadd{, vol.~7, pp. S114--S120, 2010.
}

\bibitem{iseeyou}
\BIBentryALTinterwordspacing
\DIFadd{M.~Brocker and S.~Checkoway, ``iseeyou: Disabling the macbook webcam indicator
  }{\DIFadd{LED}}\DIFadd{,'' in }\emph{\DIFadd{Proceedings of the 23rd }{\DIFadd{USENIX}} \DIFadd{Security Symposium, San
  Diego, CA, USA, August 20-22, 2014}}\DIFadd{, K.~Fu and J.~Jung, Eds.}\hskip \DIFadd{1em plus
  0.5em minus 0.4em}\relax {\DIFadd{USENIX}} \DIFadd{Association, 2014, pp. 337--352. }[\DIFadd{Online}]\DIFadd{.
  Available:
...
\bibitem{usbdriver}
\BIBentryALTinterwordspacing
\DIFadd{S.~Kamkar, ``Usbdriveby.'' 2014. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{http://samy.pl/usbdriveby/}
\BIBentrySTDinterwordspacing

\bibitem{MHLlist}
\BIBentryALTinterwordspacing
\DIFadd{MHL, ``Mhl devices,'' 2021. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{http://www.mhltech.org/devices.aspx?tid=1}
\BIBentrySTDinterwordspacing

\bibitem{li2018usb}
\DIFadd{A.~Li, ``Usb type-c for machine vision,'' }\emph{\DIFadd{Quality}}\DIFadd{, pp. 16VS--17VS, 2018.
}

\bibitem{flame}
\DIFadd{K.~Zetter, ``Meet ‘flame,’the massive spy malware infiltrating iranian
  computers,'' }\emph{\DIFadd{Wired Magazine}}\DIFadd{, 2012.
}

\bibitem{brain}
\DIFadd{H.~J. Highland, ``The brain virus: fact and fantasy,'' }\emph{\DIFadd{Computers \&
  Security}}\DIFadd{, vol.~7, no.~4, pp. 367--370, 1988.
}

\bibitem{stuxnet}
\BIBentryALTinterwordspacing
\DIFadd{``Common vulnerabilities and exposures,'' 2010. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2010-2568,}
\BIBentrySTDinterwordspacing

\bibitem{conficker}
\BIBentryALTinterwordspacing
\DIFadd{S.~Shin and G.~Gu, ``Conficker and beyond: a large-scale empirical study,'' in
  }\emph{\DIFadd{Twenty-Sixth Annual Computer Security Applications Conference, }{\DIFadd{ACSAC}}
  \DIFadd{2010, Austin, Texas, USA, 6-10 December 2010}}\DIFadd{, C.~Gates, M.~Franz, and J.~P.
  McDermott, Eds.}\hskip \DIFadd{1em plus 0.5em minus 0.4em}\relax {\DIFadd{ACM}}\DIFadd{, 2010, pp.
  151--160. }[\DIFadd{Online}]\DIFadd{. Available: }\url{https://doi.org/10.1145/1920261.1920285}
\BIBentrySTDinterwordspacing

\bibitem{zero-day}
\BIBentryALTinterwordspacing
\DIFadd{Z.~Wang and A.~Stavrou, ``Exploiting smart-phone }{\DIFadd{USB}} \DIFadd{connectivity for fun and
  profit,'' in }\emph{\DIFadd{Twenty-Sixth Annual Computer Security Applications
  Conference, }{\DIFadd{ACSAC}} \DIFadd{2010, Austin, Texas, USA, 6-10 December 2010}}\DIFadd{, C.~Gates,
  M.~Franz, and J.~P. McDermott, Eds.}\hskip \DIFadd{1em plus 0.5em minus 0.4em}\relax
  {\DIFadd{ACM}}\DIFadd{, 2010, pp. 357--366. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://doi.org/10.1145/1920261.1920314}
\BIBentrySTDinterwordspacing

\bibitem{smartphone}
\BIBentryALTinterwordspacing
\DIFadd{------, ``Exploiting smart-phone }{\DIFadd{USB}} \DIFadd{connectivity for fun and profit,'' in
  }\emph{\DIFadd{Twenty-Sixth Annual Computer Security Applications Conference, }{\DIFadd{ACSAC}}
  \DIFadd{2010, Austin, Texas, USA, 6-10 December 2010}}\DIFadd{, C.~Gates, M.~Franz, and J.~P.
  McDermott, Eds.}\hskip \DIFadd{1em plus 0.5em minus 0.4em}\relax {\DIFadd{ACM}}\DIFadd{, 2010, pp.
  357--366. }[\DIFadd{Online}]\DIFadd{. Available: }\url{https://doi.org/10.1145/1920261.1920314}
\BIBentrySTDinterwordspacing

\bibitem{poweremi}
\DIFadd{K.~Sridhar, S.~Prasad, L.~Punitha, and S.~Karunakaran, ``Emi issues of
  universal serial bus and solutions,'' in }\emph{\DIFadd{8th International Conference
  on Electromagnetic Interference and Compatibility}}\DIFadd{.}\hskip \DIFadd{1em plus 0.5em
  minus 0.4em}\relax \DIFadd{IEEE, 2003, pp. 97--100.
}

\bibitem{revealing}
\DIFadd{A.~Davis, ``Revealing embedded fingerprints: Deriving intelligence from usb
  stack interactions,'' }\emph{\DIFadd{Blackhat USA}}\DIFadd{, 2013.
}

\bibitem{su2017usb}
\BIBentryALTinterwordspacing
\DIFadd{Y.~Su, D.~Genkin, D.~C. Ranasinghe, and Y.~Yarom, ``}{\DIFadd{USB}} \DIFadd{snooping made easy:
  Crosstalk leakage attacks on }{\DIFadd{USB}} \DIFadd{hubs,'' in }\emph{\DIFadd{26th }{\DIFadd{USENIX}} \DIFadd{Security
  Symposium, }{\DIFadd{USENIX}} \DIFadd{Security 2017, Vancouver, BC, Canada, August 16-18,
  2017}}\DIFadd{, E.~Kirda and T.~Ristenpart, Eds.}\hskip \DIFadd{1em plus 0.5em minus
  0.4em}\relax {\DIFadd{USENIX}} \DIFadd{Association, 2017, pp. 1145--1161. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://www.usenix.org/conference/usenixsecurity17/technical-sessions/presentation/su}
\BIBentrySTDinterwordspacing

\bibitem{usbgpslocator}
\BIBentryALTinterwordspacing
\DIFadd{mich., ``Inside a low budget consumer hardware espionage implant.'' 2017.
  }[\DIFadd{Online}]\DIFadd{. Available: }\url{https://ha.cking.ch/s8 data line locator}
\BIBentrySTDinterwordspacing

\bibitem{bates2014leveraging}
\BIBentryALTinterwordspacing
\DIFadd{A.~Bates, R.~Leonard, H.~Pruse, D.~Lowd, and K.~R.~B. Butler, ``Leveraging
  }{\DIFadd{USB}} \DIFadd{to establish host identity using commodity devices,'' in }\emph{\DIFadd{21st
  Annual Network and Distributed System Security Symposium, }{\DIFadd{NDSS}} \DIFadd{2014, San
  Diego, California, USA, February 23-26, 2014}}\DIFadd{.}\hskip \DIFadd{1em plus 0.5em minus
  0.4em}\relax \DIFadd{The Internet Society, 2014. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://www.ndss-symposium.org/ndss2014/leveraging-usb-establish-host-identity-using-commodity-devices}
\BIBentrySTDinterwordspacing

\bibitem{badusbhub}
\BIBentryALTinterwordspacing
\DIFadd{K.~Nohl, ``Badusb exposure: Hubs,'' 2014. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://opensource.srlabs.de/projects/badusb/wiki/Hubs}
\BIBentrySTDinterwordspacing

\bibitem{usbfinger}
\BIBentryALTinterwordspacing
\DIFadd{L.~Letaw, J.~Pletcher, and K.~R.~B. Butler, ``Host identification via }{\DIFadd{USB}}
  \DIFadd{fingerprinting,'' in }\emph{\DIFadd{2011 }{\DIFadd{IEEE}} \DIFadd{Sixth International Workshop on
  Systematic Approaches to Digital Forensic Engineering, }{\DIFadd{SADFE}} \DIFadd{2011, Oakland,
  CA, USA, May 26, 2011}}\DIFadd{, R.~F. Erbacher, R.~H. Campbell, and Y.~Guan,
  Eds.}\hskip \DIFadd{1em plus 0.5em minus 0.4em}\relax {\DIFadd{IEEE}} \DIFadd{Computer Society, 2011,
  pp. 1--9. }[\DIFadd{Online}]\DIFadd{. Available: }\url{https://doi.org/10.1109/SADFE.2011.9}
\BIBentrySTDinterwordspacing

\bibitem{side}
\BIBentryALTinterwordspacing
\DIFadd{D.~F. Oswald, B.~Richter, and C.~Paar, ``Side-channel attacks on the yubikey 2
  one-time password generator,'' in }\emph{\DIFadd{Research in Attacks, Intrusions, and
  Defenses - 16th International Symposium, }{\DIFadd{RAID}} \DIFadd{2013, Rodney Bay, St. Lucia,
  October 23-25, 2013. Proceedings}}\DIFadd{, ser. Lecture Notes in Computer Science,
  S.~J. Stolfo, A.~Stavrou, and C.~V. Wright, Eds., vol. 8145.}\hskip \DIFadd{1em plus
  0.5em minus 0.4em}\relax \DIFadd{Springer, 2013, pp. 204--222. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://doi.org/10.1007/978-3-642-41284-4\_11}
\BIBentrySTDinterwordspacing

\bibitem{usbee}
\BIBentryALTinterwordspacing
\DIFadd{M.~Guri, M.~Monitz, and Y.~Elovici, ``Usbee: Air-gap covert-channel via
  electromagnetic emission from }{\DIFadd{USB}}\DIFadd{,'' in }\emph{\DIFadd{14th Annual Conference on
  Privacy, Security and Trust, }{\DIFadd{PST}} \DIFadd{2016, Auckland, New Zealand, December
  12-14, 2016}}\DIFadd{.}\hskip \DIFadd{1em plus 0.5em minus 0.4em}\relax {\DIFadd{IEEE}}\DIFadd{, 2016, pp.
  264--268. }[\DIFadd{Online}]\DIFadd{. Available: }\url{https://doi.org/10.1109/PST.2016.7906972}
\BIBentrySTDinterwordspacing

\bibitem{turnip}
\BIBentryALTinterwordspacing
\DIFadd{TURNIPSCHOOL, ``Nsa playset.'' }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{http://www.nsaplayset.org/turnipschool}
\BIBentrySTDinterwordspacing

\bibitem{usbkiller}
\BIBentryALTinterwordspacing
\DIFadd{``Usbkiller,'' 2016. }[\DIFadd{Online}]\DIFadd{. Available: }\url{https://www.usbkill.com/}
\BIBentrySTDinterwordspacing

\bibitem{Condom}
\BIBentryALTinterwordspacing
\DIFadd{INT3.CC, ``The original usb condom,'' 2018. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://int3.cc/collections/usb/products/usbcondoms}
\BIBentrySTDinterwordspacing

\bibitem{windenfenderwhite}
\BIBentryALTinterwordspacing
\DIFadd{Microsoft, ``How to control usb devices and other removable media using
  microsoft defender for endpoint,'' 2018. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://docs.microsoft.com/en-us/windows/security/threat-protection/device-control/control-usb-devices-using-intune\#prevent-installation-of-specifically-prohibited-peripherals}
\BIBentrySTDinterwordspacing

\bibitem{mohammadmoradi2018making}
\BIBentryALTinterwordspacing
\DIFadd{H.~Mohammadmoradi and O.~Gnawali, ``Making whitelisting-based defense work
  against badusb,'' in }\emph{\DIFadd{Proceedings of the 2nd International Conference on
  Smart Digital Environment, }{\DIFadd{ICSDE}} \DIFadd{2018, Rabat, Morocco, October 18-20,
  2018}}\DIFadd{, F.~E. Bouanani and A.~Habbani, Eds.}\hskip \DIFadd{1em plus 0.5em minus
  0.4em}\relax {\DIFadd{ACM}}\DIFadd{, 2018, pp. 127--134. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://doi.org/10.1145/3289100.3289121}
\BIBentrySTDinterwordspacing

\bibitem{yang2015tmsui}
\BIBentryALTinterwordspacing
\DIFadd{B.~Yang, Y.~Qin, Y.~Zhang, W.~Wang, and D.~Feng, ``}{\DIFadd{TMSUI:}} {\DIFadd{A}} \DIFadd{trust
  management scheme of }{\DIFadd{USB}} \DIFadd{storage devices for industrial control systems,''
  in }\emph{\DIFadd{Information and Communications Security - 17th International
  Conference, }{\DIFadd{ICICS}} \DIFadd{2015, Beijing, China, December 9-11, 2015, Revised
  Selected Papers}}\DIFadd{, ser. Lecture Notes in Computer Science, S.~Qing,
  E.~Okamoto, K.~Kim, and D.~Liu, Eds., vol. 9543.}\hskip \DIFadd{1em plus 0.5em minus
  0.4em}\relax \DIFadd{Springer, 2015, pp. 152--168. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://doi.org/10.1007/978-3-319-29814-6\_13}
\BIBentrySTDinterwordspacing

\bibitem{usbesafe}
\BIBentryALTinterwordspacing
\DIFadd{A.~Kharraz, B.~L. Daley, G.~Z. Baker, W.~Robertson, and E.~Kirda, ``}{\DIFadd{USBESAFE:}}
  \DIFadd{an end-point solution to protect against usb-based attacks,'' in }\emph{\DIFadd{22nd
  International Symposium on Research in Attacks, Intrusions and Defenses,
  }{\DIFadd{RAID}} \DIFadd{2019, Chaoyang District, Beijing, China, September 23-25, 2019}}\DIFadd{.}\hskip
  \DIFadd{1em plus 0.5em minus 0.4em}\relax {\DIFadd{USENIX}} \DIFadd{Association, 2019, pp. 89--103.
  }[\DIFadd{Online}]\DIFadd{. Available:
...
\bibitem{MuellerZN19}
\BIBentryALTinterwordspacing
\DIFadd{T.~Mueller, E.~Zimmer, and L.~de~Nittis, ``Using context and provenance to
  defend against usb-borne attacks,'' in }\emph{\DIFadd{Proceedings of the 14th
  International Conference on Availability, Reliability and Security, }{\DIFadd{ARES}}
  \DIFadd{2019, Canterbury, UK, August 26-29, 2019}}\DIFadd{.}\hskip \DIFadd{1em plus 0.5em minus
  0.4em}\relax {\DIFadd{ACM}}\DIFadd{, 2019, pp. 1:1--1:9. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://doi.org/10.1145/3339252.3339268}
\BIBentrySTDinterwordspacing

\bibitem{neuner2018usblock}
\BIBentryALTinterwordspacing
\DIFadd{S.~Neuner, A.~G. Voyiatzis, S.~Fotopoulos, C.~Mulliner, and E.~R. Weippl,
  ``Usblock: Blocking usb-based keypress injection attacks,'' in }\emph{\DIFadd{Data and
  Applications Security and Privacy }{\DIFadd{XXXII}} \DIFadd{- 32nd Annual }{\DIFadd{IFIP}} {\DIFadd{WG}} \DIFadd{11.3
  Conference, DBSec 2018, Bergamo, Italy, July 16-18, 2018, Proceedings}}\DIFadd{, ser.
  Lecture Notes in Computer Science, F.~Kerschbaum and S.~Paraboschi, Eds.,
  vol. 10980.}\hskip \DIFadd{1em plus 0.5em minus 0.4em}\relax \DIFadd{Springer, 2018, pp.
  278--295. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://doi.org/10.1007/978-3-319-95729-6\_18}
\BIBentrySTDinterwordspacing

\bibitem{pham2010optimizing}
\DIFadd{D.~V. Pham, M.~N. Halgamuge, A.~Syed, and P.~Mendis, ``Optimizing windows
  security features to block malware and hack tools on usb storage devices,''
  in }\emph{\DIFadd{Progress in electromagnetics research symposium}}\DIFadd{, 2010.
}

\bibitem{meng2018252}
\DIFadd{W.~Meng, L.~Jiang, Y.~Wang, J.~Li, J.~Zhang, and Y.~Xiang, ``Jfcguard:
  Detecting juice filming charging attack via processor usage analysis on
  smartphones,'' }\emph{\DIFadd{Computers \& Security}}\DIFadd{, vol.~76, pp. 252 -- 264, 2018.
}

\bibitem{cable}
\BIBentryALTinterwordspacing
\DIFadd{B.~Leung, ``Surjtech’s 3m usb a-to-c cable completely violates the usb spec.
  seriously damaged my laptop,'' 2016. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://www.amazon.com/review/R2XDBFUD9CTN2R}
\BIBentrySTDinterwordspacing

\bibitem{pi4b}
\BIBentryALTinterwordspacing
\DIFadd{R.~P. Foundation, ``Raspberry pi }{\DIFadd{4B}}\DIFadd{,'' 2019. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://www.raspberrypi.org/products/raspberry-pi-4-model-b}
\BIBentrySTDinterwordspacing

\bibitem{atmel}
\BIBentryALTinterwordspacing
\DIFadd{M.~T. Incorporated, ``}{\DIFadd{ATmega32u4}} \DIFadd{chip,'' 2016. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://www.microchip.com/wwwproducts/en/ATmega32u4}
\BIBentrySTDinterwordspacing

\bibitem{ugreen}
\BIBentryALTinterwordspacing
\DIFadd{U.~G. Limited, ``}{\DIFadd{UGREEN}} \DIFadd{company introduction,'' 2012. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://www.ugreen.com/pages/about-ugreen}
\BIBentrySTDinterwordspacing

\bibitem{appleman}
\BIBentryALTinterwordspacing
\DIFadd{Apple, ``Mac notebooks: Key placement and functions,'' 2017. }[\DIFadd{Online}]\DIFadd{.
  Available: }\url{https://support.apple.com/en-us/HT201181}
\BIBentrySTDinterwordspacing

\bibitem{Brick}
\BIBentryALTinterwordspacing
\DIFadd{Brick, ``Brick,'' 2019. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://brickapp.se/about-us/}
\BIBentrySTDinterwordspacing

\bibitem{Wechat-pay}
\BIBentryALTinterwordspacing
\DIFadd{``}{\DIFadd{WeChat Pay}}\DIFadd{,'' 2020. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://pay.weixin.qq.com/index.php/public/wechatpay_en}
\BIBentrySTDinterwordspacing

\bibitem{AliPay}
\BIBentryALTinterwordspacing
\DIFadd{Alipay, ``Alipay,'' 2020. }[\DIFadd{Online}]\DIFadd{. Available:
  }\url{https://global.alipay.com/platform/site/ihome}
\BIBentrySTDinterwordspacing

\bibitem{usbcheckin}
\BIBentryALTinterwordspacing
\DIFadd{F.~Griscioli, M.~Pizzonia, and M.~Sacchetti, ``Usbcheckin: Preventing badusb
  attacks by forcing human-device interaction,'' in }\emph{\DIFadd{14th Annual
  Conference on Privacy, Security and Trust, }{\DIFadd{PST}} \DIFadd{2016, Auckland, New Zealand,
  December 12-14, 2016}}\DIFadd{.}\hskip \DIFadd{1em plus 0.5em minus 0.4em}\relax {\DIFadd{IEEE}}\DIFadd{, 2016,
  pp. 493--496. }[\DIFadd{Online}]\DIFadd{. Available:
