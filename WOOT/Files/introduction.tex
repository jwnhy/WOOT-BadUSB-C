...
Although many smartphones equipped with USB-C connectors do not support \ac{USB} 3.x protocol, such as products of Xiaomi, however, vendors like HUAWEI and Samsung tend to support \ac{USB} 3.x protocol in their \mbox{high-end} smartphones~\cite{usbclist}.
...
including \ac{HID} emulation mode, video capture mode, and full control mode. To improve the
