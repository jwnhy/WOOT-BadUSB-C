...
\textbf{\ac{HID} Emulation Mode.} This mode mainly relies on the ``\ac{HID} Emulator'' in the Figure\shuqing{fig 3 delete?}~\ref{fig:attack_model} to
...
input source. Hence we can achieve complete hijack of victim's device.
...
The advantage of this mode is that it can completely hijack the victims device
