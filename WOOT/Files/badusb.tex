...
%Though BadUSB devices\cite{badusb} like Rubber Ducky\cite{rubber, rubberducky2020} emulates as a HID device enabling various arbitrary execution attacks, fetching feedback from the victim is much more limited. 
