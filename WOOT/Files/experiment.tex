...
for its external screen, which enable users to use their devices as if they were using a computer with an external monitor.
...
device in this experiment.  Besides disguising themselves as normal \acp{HID} like a
...
Pay~\cite{Wechat-pay} regards transactions under US\textdollar 154 as
