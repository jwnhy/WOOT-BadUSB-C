...
2020}, a PC in Windows 10 \mbox{(OS Build 18363.1379)} with two \ac{USB} Type-C interfaces as the
...
After collecting the captured videos of the mobile phone, we analyzed the videos automatically.
...
In total, there are 94,058 entries of data from 10 volunteers.
