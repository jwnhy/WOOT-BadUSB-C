...
\circled[text=white,fill=myblue]{\scriptsize{A}} is a Huawei mobile phone as the victim's device; \circled[text=white,fill=myblue]{\scriptsize{B}} is a compact look of \tool prototype; \circled[text=white,fill=myblue]{\footnotesize{1}} is the USB 3.x Hub; \circled[text=white,fill=myblue]{\footnotesize{2}} is a Raspberry Pi 4B as the Single Board Computer; \circled[text=white,fill=myblue]{\footnotesize{3}} is an auxiliary power bank; \circled[text=white,fill=myblue]{\footnotesize{4}} is the Video Capture Card; \circled[text=white,fill=myblue]{\footnotesize{5}} is an Atmel ATMEGA32U4 board as the HID Emulator.
...
At last, we found 4,172 of 94,058 records obtained by \tool which are related to privacy information, as shown in the Table.
...
\begin{table*}[t]
	...
	\begin{tabular}{|c|c|c|c|c|}
		\hline
		\textbf{Category}  & \textbf{Application} & \textbf{Leaked Sensitive Information}                      \\
		\hline
		Finance App         & Alipay      & Alipay account, personal assets (blance)          \\
		\hline
		Social  Finance App & WeChat      & WeChat account, , chat history             \\
		\hline
		...
		\hline
		Finance App         & ICBC        & ICBC account, password, personal assets (balance)  \\
		\hline
		Finance App         & Paypal      & Paypal account, balance, bank accounts            \\
		\hline
