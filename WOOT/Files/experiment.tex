...
2020}, a PC in Windows 10 (OS Build 18363.1379) with two USB Type-C interfaces as the
...
To test the capability of the full control mode, we chose iPad Pro (3rd
	generation), a tablet in iOS 14.4 (Build 18D52) with a USB Type-C interface, as the target
