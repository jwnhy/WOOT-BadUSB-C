...
\noindent\outline{Case Study: Sharing Power Bank}\\
...
\yechang{site or repository? }

As an example, Brick is such a power bank sharing service provider from Sweden. 

\yechang{add hyperlink or reference to Brick or Brick App on App Store/Google Play.}

\yechang{Add more example to show that it is widely used?}
...
\outline{Attack Procedure(how to  get picture, etc.)}\\
\outline{Security Issues against APPLE/Android...etc.}\\
