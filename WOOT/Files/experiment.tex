...
recorded all information shown in applications with or without authentication.

As the result shown in the Table~\ref{table:information_extracted}, if the victim uses a password instead of biometric authentication, the password can be leaked out and cause greater harm, such as guessing other passwords on the device.
...
\begin{table*}[t]
	...
	\begin{tabular}{|c|c|c|c|c|c|}
		...
		\hline
		Social \& Finance App 				& WeChat      & Account, Asset status, Chat History, Payment Code   & \\
		\hline
		...
		\hline
		\multirow{3}{*}{Finance App}       	& Alipay      & Account, Asset status, Payment Code         				& \\
											\cline{2-4}
											& Cash App    & Email, Phone Number, Cash Balance			& \\
											\cline{2-4}
											& Paypal      & Account, PayPal Balance     				& \\
		\hline
		...
		\hline
		\multirow{2}{*}{System}             & Contacts    &                                 	&  WiFi password \\
											\cline{2-4}
