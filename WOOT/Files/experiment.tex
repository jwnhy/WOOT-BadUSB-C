...
\ding{184} Attach attacker's \tool to the test device.
\ding{185} Simulate victim's daily usage of the application.
...
\begin{table*}[t]
	...
	\begin{tabular}{|c|c|l|l|c|c|}
		...
		\hline
		Social \& Finance App 				& WeChat      & Account, Financial Status, Chat History, Payment Code   		& Payment Password \\
		\hline
		\multirow{2}{*}{Social App}
											%& QQ          & Account, Contacts, Chat History   	& \\
											%\cline{2-4}
							       			& WhatsApp    & Account, Contacts, Chat History, Phone Number    & \\
											\cline{2-4}
							       			& Facebook    & Account, Posts, Contacts           & \\
		\hline
		\multirow{3}{*}{Finance App}       	& Alipay      & Account, Financial Status, Payment Code         				& Payment Password \\
											\cline{2-4}
		...
		\hline
		\multirow{3}{*}{System}             &  Messages   & Contacts, Chat History				 &   \\
											\cline{2-4}
