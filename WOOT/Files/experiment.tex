...
Sharing power banks not only provide convenience to users, but also bring security issues.  We noticed that most of the power bank stations do not
...
====================================================
As illustrated in Figure~\ref{fig:qr_payment_procedure}, QR code payment information from the video stream.  
When the victim viewed text or photos withnt is typically performed in the following steps:
====================================================
