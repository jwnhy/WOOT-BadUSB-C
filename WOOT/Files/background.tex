...
Right after one year of the appearance of \ac{USB} 1.0, a standard named \acf{HID}~\cite{hid} was born based on \ac{USB}. \ac{HID} is
...
In 1998, the first widely supported \ac{USB} protocol was born. \ac{USB} 1.1~\cite{usb11}
...
\ac{USB} 3.0~\cite{usb30} was announced in 2008, with a super speed (5 Gbit/s) data
...
During the development of \ac{USB} specification, security was rarely considered. As
...
\begin{tabular}{|c|l|c|c|c|}
	...
	\hline
	1996 & \ac{USB} 1.x~\cite{usb10,usb11} & Keyboard, Mouse... & 1.5 Mbit/s or 12 Mbit/s & \ac{HID} Emulating (BadUSB)~\cite{badusb} \\
	\hline
