...
Interface Device)\hongyi{Citation Needed} was born on the basis of USB. HID is
...
standard called USB Type-C is introduced in 2013 by USB-IF\fengwei{Need a
citation}. As it is designed to be double-sided, the number of actual usable
...
to decide whether security features should be implemented.\hongyi{Citation
needed}. But the divergent implementations give a chance for attack like
