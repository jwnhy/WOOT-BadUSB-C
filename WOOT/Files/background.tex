...
standard called USB Type-C~\cite{typec} is introduced in 2013 by USB-IF~\cite{usbif}.\fengwei{Add a citation for USB-IF} As it is designed to be double-sided, the number of actually usable
