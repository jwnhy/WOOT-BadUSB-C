...
\fengwei{use "cannot" instead of "can't"} be transferred via USB cable. Based
...
To solve this flaw, GoodUSB~\cite{tian2015defending} will\fengwei{Don't use
future tense. We can just use present tense.} report the functionality claimed
