...
rootkit to hide malicious files on the \ac{USB} storage device, \cite{flame} uses a
...
but they require certain existing flaws like a \cite{zero-day} vulnerability and \ac{USB} is merely
...
feature vector constructed from with data collected from \acp{URB}, 
