...
be transmitted through the USB interface. JFC~\cite{JFC}, short for Juicy Filming Attacks is such a work that abuses this standard and exfiltrate video data
...
exists an attack called JFC~\cite{JFC} which abuses the MHL
