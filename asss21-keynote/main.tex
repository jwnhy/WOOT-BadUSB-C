...
\title{Keynote: BadUSB-C: Revisiting BadUSB with Type-C}

\author{\textbf{Fengwei Zhang} \\\vspace{3pt}  \includegraphics[width=1.5cm]{name.jpg}}
\institute{COMPASS Lab, SUSTech\\ \vspace{5pt}
\includegraphics[width=1.5cm]{sustech-logo.jpeg}}
